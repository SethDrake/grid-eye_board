...
protected:
	...
	volatile uint32_t spiPrescaler;
	GPIO_TypeDef* rsPort;
	GPIO_TypeDef* csPort;
...
private:
	void setSPISpeed(uint32_t prescaler);
	void setSPIDataSize(const uint32_t spiDataSize);
	...
	void initDMAforSendSPI(uint8_t singleColor);
