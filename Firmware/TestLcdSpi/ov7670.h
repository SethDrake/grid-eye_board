...
#define CAM_PCLK_HREF_PORT GPIOA
#define CAM_PCLK_PIN	   GPIO_PIN_6
#define CAM_HREF_PIN	   GPIO_PIN_4

#define CAM_VSYNC_D3_PORT  GPIOG
#define CAM_VSYNC_PIN	   GPIO_PIN_9
#define CAM_DATA3_PIN	   GPIO_PIN_11

#define CAM_D0_1_2_PORT	   GPIOC
#define CAM_DATA0_PIN	   GPIO_PIN_6
#define CAM_DATA1_PIN	   GPIO_PIN_7
#define CAM_DATA2_PIN	   GPIO_PIN_8

#define CAM_D4_6_7_PORT	   GPIOE
...
public:
	OV7670();
	~OV7670();
	bool init(I2C_HandleTypeDef* i2cHandle, const uint32_t fb_addr);
	void DCMI_Interrupt();
	void DCMI_DMA_Interrupt();
	void captureFrame();
	bool isFrameReady();
	bool isCameraOk();
	void frameCompleted();
...
private:
	...
	DMA_HandleTypeDef dcmiDmaHandle;
	volatile bool isOk;
	volatile bool isCaptureInProgress;
...
static struct regval_list OV7670_reg[] = {
	/* Color mode related */
	{ REG_COM7, COM7_FMT_QVGA | COM7_RGB },   // QVGA, RGB
	{ REG_RGB444, 0x00 },   // RGB444 Disable
	{ REG_COM15, COM15_RGB565 | COM15_R00FF },   // RGB565, 00 - FF
	{ REG_TSLB, 0x04 | 0x08 },   // UYVY (why?)
	{ REG_COM13, COM13_GAMMA | COM13_UVSAT },   // gamma enable, UV auto adjust, UYVY
	{ 0xB0, 0x84 }, // important

					/* clock related */
	{ REG_COM3, COM3_DCWEN },  // DCW enable
	{ REG_COM14, COM14_DCWEN | 0x09 },  // manual scaling, pclk/=2
	...
	{ REG_VREF, 0x0a },   // VREF (VSTART_LOW = 2, VSTOP_LOW = 2)
