...
static const struct regval_list ov7670_default_regs[] = {//from the linux driver
	...
	{ 0x91, 0 },{ 0x96, 0 },
	{ 0x9a, 0 },{ 0xb0, 0x84 },
	{ 0xb1, 0x0c /*Doesn't work Automatic Black Level change to 0b00001111*/ },{ 0xb2, 0x0e },
	{ 0xb3, 0x82 },{ 0xb8, 0x0a },
...
static const regval_list OV7670_regs[] = {
	/* Color mode related */
	{ 0x12, 0x14 },   // QVGA, RGB
...
static const struct regval_list rgb565_ov7670[] = {
	...
	{ REG_COM9, 0x6A },	 /* 128x gain ceiling; 0x8 is reserved bit ( 0x6A) is original value */
